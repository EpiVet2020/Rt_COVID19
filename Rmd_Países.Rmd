...
<br>
<br>
A partir desde gráfico, é possível constatar que o número de reprodução efetivo inicial atingiu os 2,72 (8 de Março), o que não parece ter sido muito diferente em relação aos restantes países da união europeia. No entanto, neste caso, os dados utilizados só terão começado a ser reportados a partir de 1 de Março. Desde então, com a implementação do confinamento parcial e posteriormente total a nível nacional, o número de contágios diminuiu até um Rt de 0,60 no dia 1 de Maio. <br>
...
O primeiro caso confirmado de COVID-19 na República checa foi no dia 1 de Março, e neste mesmo dia o Rt = 18,05, que representou o pico da transmissibilidade neste país. No dia 12 de Março foi declarado o Estado de Emergência, com a duração de um mês, o que permitiu que existisse uma redução dos valores de transmissibilidade, até um minimo de 0,62 no dia 16 de Abril. <br>
No dia 11 de Maio foram reabertas as lojas, permitindo uma maior abertura, após esta decisão existiram ligeiras oscilações nos valores de Rt, com um máximo de 0,94 no dia 28 de Junho, posteriormente atingindo um mínimo de 0.66 no dia 6 de Julho. Após o fim do Verão, chegou a 2ª vaga de casos, levando a que fossem impostas novas medidas de restrição, um novo Estado de Emergência no dia 5 de outubro e a proibição das movimentações no dia 22 de outubro, existindo uma redução dos valores de Rt. Desde então, o este valor é inferior a 1 (0,99).
...
Na Suiça as primeiras medidas começaram a ser tomadas no final do mês de fevereiro, devido às celebrações de Carnaval, quando se deram os primeiros casos, a 24 de fevereiro. Os valores iniciais de Rt foram de 23,14 a 26 de fevereiro. No dia 13 de março foram aplicadas algumas medidas restritivas, como o encerramento de escolas, e no dia 16 de março declarado o Estado de Emergência. Estes acontecimentos levaram a que existisse uma redução nos valores de transmissibilidade, até um mínimo de 0,62 no dia 16 de abril. A partir do dia 27 de abril as restrições foram sendo levantadas, levando a um aumento do númemro de casos, e consequentemente do Rt para valores de 1,78 (1 de julho). <br>
A partir de meados de setembro existe um aumento de casos generalizado em toda a Europa, o que provocou o aumento do número de reprodução para 1,79 no dia 9 de outubro. Foram aplicadas novamente medidas de restrição, como a proibição de ajuntamentos no dia 19 de outubro, o que permitiu que existisse uma ligeira redução dos valores de Rt, até ao atual de 1,08 (4 de novembro).
...
É importante analisar os dados da Suécia, visto que este país defendeu uma filosofia de combate ao vírus muito diferente dos restantes países europeus, a imunidade de grupo. <br>
A Suécia teve o primeiro caso de COVID-19 no dia 26 de fevereiro, no qual o valor de Rt era de 8,27. Após este dia, apresentou o valor máximo de transmissibilidade no dia 28 de  fevereiro, de 23,14, apresentando em seguida uma redução drástica destes valores, culminando num mínimo de 1,06 no dia em que as escolas foram encerradas (19 de março). Existiu, em seguida, um novo aumento dos valores de Rt, para 1,57 no dia 28 de março. Neste mesmo dia foi aplicada a proibição de ajuntamentos comm mais de 50 pessoas, o que permitiu a redução da transmissibilidade para valores inferiores a 1 (0,99 no dia 14 de abril). <br>
Entre abril e setembro os valores de Rt oscilaram ligeiramente, apresentando-se na sua maioria superiroes a 1, mas também alcançando o seu mínimo no dia 10 de julho (0,60). A partir de setembro é visível que estes valores sofreram novamente um aumento, visto que desde o dia 4 de setembro não apresentaram valores inferiores a 1. <br>
Devido ao aumento preocupante de casos no mês de outubro, no dia 1 de novembro foi feita a recomendação de teletrabalho, o que permitiu uma ligeira diminuição dos valores de Rt para 1,33 (4 de novembro). <br>
...
Ao longo de Março, os valores de contágio foram diminuindo, sendo esta descida ainda mais reforçada após a implementação de confinamento obrigatório no dia 24 de Março (embora um pouco mais tardiamente que os restantes países). Desta forma, só a partir de Maio é que os valores de Rt se mantiveram abaixo de 1 e foi ainda implementada quarentena obrigatória para todos os passageiros de chegada ao Reino Unido a partir de dia 22 deste mês.  <br>
...
### Nova Zelândia
<br>
Para este país foram analisados os dados da Organização Mundial de Saúde, através do seguinte documento: https://covid19.who.int/WHO-COVID-19-global-data.csv.
<br>
...
Como podemos observar no gráfico, a Índia apresentou valores de transmissão na ordem dos 37 no início de março, que poderá ser enviesado devido à possibilidade do número de novos casos confirmados poder ter sido subestimado. Ainda assim, trata-se de um valor mais elevado que os restantes países, o que pode refletir a dificuldade de implementação de medidas de restrição neste país. A partir de 4 de março começou a ser realizada a triagem a todos os passageiros e, mais tarde, a 25 de Março foi implementado o confinamento obrigatório. <br>
...
No caso da China, país onde o vírus teve origem, o maior valor de transmissão de doença verificou-se inicialmente (Rt = 7.86; 12 de janeiro), uma vez que toda a população se encontrava suscetível e potencialmente exposta a um microrganismo até então desconhecido. Apesar do Rt ter sofrido um pequeno decréscimo até 18 de Janeiro, a partir desta data foi-se acentuando até um novo pico no dia 22 de Janeiro, apresentando um valor bastante considerável (Rt = 5.29). No dia 23 de Janeiro foi implementado o confinamento parcial em xinjiang. <br>
Em meados de fevereiro, o número de novos casos voltou a ser mais reduzido na sequência destas medidas, pelo que o Rt dos dias anteriores acompanhou esta tendência e voltou a apresentar valores decrescentes até dia 14 de março, com o Rt mais baixo desde o início da pandemia (Rt = 0.23). Embora a transmissibilidade tenha voltado a aumentar nos dias seguintes, a implementação de confinamento parcial em Xinjiang contribuiu para a limitação da propagação de doença e dia 26 de Abril o Rt voltou a apresentar o valor mais baixo desde então (Rt = 0.24). <br>
De Maio a Junho podemos verificar que foi difícil limitar a transmissão de infeção, com um novo pico de Rt a 16 de Junho (Rt = 2.97). Desde então, com um novo confinamento, desta vez total, em Xinjiang e posteriormente a implementação gradual de confinamento em Hubei, contribuiram para diminuir a transmissibilidade até valores inferiores a 1.
A partir de Setembro, os valores de Rt mantiveram-se bastante próximos do 1, no limiar de transmissão. 
<br>
...
<br>
Para a análise da evolução do Rt nos Estados Unidos da América, utilizou-se a seguinte base de dados: https://data.cdc.gov/Case-Surveillance/COVID-19-Case-Surveillance-Public-Use-Data/vbim-akqf.
<br>
<br>
...
No Japão, podemos verificar que o valor máximo de Rt se verificou no dia 18 de fevereiro (Rt = 3.09), altura em que ainda não tinham sido implementadas medidas de restrição e de distanciamento social, levando assim a uma maior transmissão de vírus. <br>
No dia 29 do mês seguinte, foi atingido um novo pico de 2.03, no entanto, a curva iniciou a sua descida logo após esta data com a declaração do Estado de Emergência no dia 7 de abril. Apesar deste não obrigar ao confinamento da população, sendo apenas voluntário, foi suficiente para fazer o Rt decrescer até ao valor mínimo de 0.49 ao dia 11 de maio. Duas semanas mais tarde, o Estado de Emergência foi suspenso (25 de maio) e desde essa data e 4 de julho, registou-se um aumento progressivo do Rt. Desde então o Rt diminuiu e, a partir de Setembro, veio a estabilizar com valores bastante próximos do 1, o que indica que a doença se manteve uniformemente na população.
...
### México
<br>
Para a análise da evolução do Rt no México, utilizou-se a base de dados documentada em: https://covid19.who.int/WHO-COVID-19-global-data.csv.
<br>
<br>

No México, os primeiros casos foram registados no fim de fevereiro e o pico no Rt (Rt = 6.68) foi atingido no dia 15 de março, refletindo a elevada transmissão de vírus, uma vez que nesta altura ainda não existiam medidas de restrição em vigor. No fim de março foi declarado o Estado de Emergência e observou-se uma descida gradual no Rt até valores próximos de 1. <br>
Até meados de outubro, apenas se registaram pequenas flutuações e no dia 10 de outubro deu-se um novo pico (Rt = 1.77), retomando depois valores mais constantes, sempre próximos de 1. 
...
Numa primeira fase da pandemia na Coreia do Sul, verificou-se uma elevada transmissão de vírus, com o Rt a atingir valores na ordem dos 14 no dia 22 de fevereiro. O governo coreano apresentou uma abordagem baseada na testagem da população, permitindo detetar, isolar e tratar todos os positivos, contrastanto com as medidas de confinamento total e obrigatório implementadas nos outros países. Desde meados de março, que esta medida se fez refletir na transmissão, com uma consequente diminuição do Rt.<br>
No dia 17 de agosto, surgiu um novo pico (Rt = 2.63) porém, este aumento da transmissão foi rapidamente controlado através do confinamento parcial decretado no dia anterior, voltando o valor de Rt a diminuir e estabilizar em valores perto de 1. 
