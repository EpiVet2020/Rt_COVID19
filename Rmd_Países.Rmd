...
```{r, fig.align="center", fig.width=10, fig.height=11, warning = FALSE, message = FALSE}
...
```{r, fig.align="center", fig.width=15, fig.height=15, warning = FALSE, message = FALSE}
...
Inês Marçal Antunes [`r icon::fa("linkedin")`](https://www.linkedin.com/in/in%C3%AAs-antunes-b332401b9/) | Sara Sequeira [`r icon::fa("linkedin")`](https://www.linkedin.com/in/sara-sequeira-1b5085152/) | Teresa da Penha Coutinho [`r icon::fa("linkedin")`](https://www.linkedin.com/in/teresa-da-penha-coutinho/)
