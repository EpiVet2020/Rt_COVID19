...
### Itália
<br>
Esta análise foi realizada com recurso à seguinte base de dados: <a href = "https://github.com/pcm-dpc/COVID-19/blob/master/dati-andamento-nazionale/dpc-covid19-ita-andamento-nazionale.csv">.
<br>
<br>
...
### Alemanha
<br>
Esta análise foi realizada a partir da base de dados presente no seguinte link: <a href = "https://npgeo-corona-npgeo-de.hub.arcgis.com/datasets/dd4580c810204019a7b8eb3e0b329dd6_0/data">.
<br>
<br>
...
### Espanha
<br>
Para a análise da evolução do Rt em Espanha, utilizou-se a base de dados presente em: <a href = "https://cnecovid.isciii.es/covid19/#documentaci%C3%B3n-y-datos">.
<br>
<br>
...
### Bélgica
<br>
Para esta análise, utilizou-se a base de dados presente em: <a href = "https://epistat.wiv-isp.be/covid/">.
<br>
<br>
...
### República Checa
<br>
Para a análise da evolução do Rt na República Checa, utilizou-se a base de dados presente em: <a href = "https://onemocneni-aktualne.mzcr.cz/api/v2/covid-19">.
<br>
<br>
...
### Suíça
<br>
Esta análise foi efetuada com acesso aos seguintes dados: <a href = "https://www.bag.admin.ch/bag/en/home/krankheiten/ausbrueche-epidemien-pandemien/aktuelle-ausbrueche-epidemien/novel-cov/situation-schweiz-und-international.html#-640157857">.
<br>
<br>
...
### Suécia
<br>
Para a análise da evolução do Rt na Suécia, utilizou-se a base de dados presente em: <h ««a href = "https://experience.arcgis.com/experience/09f821667ce64bf7be6f9f87457ed9aa/page/page_0/">.
<br>
<br>
...
### Reino Unido
<br>
No sentido de realizar esta análise, utilizaram-se os seguintes dados: <a href = "https://coronavirus.data.gov.uk/cases">.
<br>
<br>
...
### Austrália
<br>
Para a análise da evolução do Rt na Austrália, utilizou-se a base de dados presente em: <a href = "https://github.com/M3IT/COVID-19_Data/blob/master/Data/COVID_AU_national_daily_change.csv">.
...
### Nova Zelândia
<br>
Para este país foram analisados os dados da Organização Mundial de Saúde, através do seguinte documento: <a href = "https://covid19.who.int/table">.
<br>
...
### Índia
<br>
Os dados para a análise da evolução do Rt na Índia foram os seguintes: <a href = "https://api.covid19india.org/documentation/csv/">.
<br>
<br>
...
### Hong Kong
<br>
Para a análise da evolução do Rt em Hong Kong, utilizou-se a base de dados presente em: <a href = "https://data.gov.hk/en-data/dataset/hk-dh-chpsebcddr-novel-infectious-agent">.
<br>
<br>
...
### China
<br>
Para esta análise, recorreu-se à base de dados presente em: <a href = "https://covid19.who.int/table".
<br>
<br>
...
<br>
Para a análise da evolução do Rt nos Estados Unidos da América, utilizou-se a seguinte base de dados: <href = "https://github.com/nytimes/covid-19-data">.
<br>
<br>
...
### Japão
<br>
Para esta análise, utilizou-se a base de dados presente em: <a href = "https://github.com/reustle/covid19japan-data/tree/master/docs/summary">.
<br>
<br>
...
japan <- fromJSON("https://raw.githubusercontent.com/reustle/covid19japan-data/master/docs/summary/2020-11-08.json")
japan <- japan$daily
...
### México
<br>
Para a análise da evolução do Rt no México, utilizou-se a base de dados documentada em: <a href = "https://covid19.who.int/table">.
<br>
<br>
...
### Coreia do Sul
<br>
Neste caso, a análise da evolução do Rt foi realizada com base nos seguintes dados: <a href = "https://github.com/owid/covid-19-data/blob/master/public/data/ecdc/new_cases.csv">.
<br>
<br>
...
### Brasil
<br>
Por fim, para a análise da evolução do Rt no Brasil, recorreu-se ao seguinte link: <a href = "https://covid19.who.int/table">.
<br>
<br>
