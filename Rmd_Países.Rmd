...
Entre maio e junho, podemos verificar que foi difícil limitar a transmissão de infeção, com um novo pico de Rt no dia 16 de junho (Rt = 2,97).
...
Numa primeira fase da pandemia na Coreia do Sul, verificou-se uma elevada transmissão de vírus, com o Rt a atingir valores na ordem dos 14, no dia 22 de fevereiro. O governo coreano apresentou uma abordagem baseada na testagem da população, permitindo detetar, isolar e tratar todos os positivos, contrastanto com as medidas de confinamento total e obrigatório implementadas nos outros países. Desde meados de março, que esta medida se fez refletir na transmissão, com uma consequente diminuição do Rt. No dia 17 de agosto, surgiu um novo pico (Rt = 2,63) porém, este aumento nos contágios foi rapidamente controlado através do confinamento parcial que tinha sido decretado no dia 16, voltando o valor de Rt a diminuir e estabilizar em valores perto de 1. 
