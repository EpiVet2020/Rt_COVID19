...
## **Introdução**
***
O Número Básico de Reprodução (R0) indica, em média, quantas pessoas serão infetadas por um único doente. Ou seja, é o número médio de casos secundários originados a partir de um caso primário, quando o vírus é introduzido numa população que consiste somente em indivíduos suscetíveis.
...
Desta forma, quando Rt = 1, ocorre o limiar da transmissão (abaixo deste valor a doença é incapaz de se manter numa população). O objetivo mais importante será manter um R0 inferior ou igual a 1 até à disponibilidade de uma vacina eficaz.
...
Neste capítulo, iremos abordar de que forma tem evoluído a transmissão de infeção em Portugal e em cada Administração Regional de Saúde.
