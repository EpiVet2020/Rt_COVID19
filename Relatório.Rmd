...
plot <- ggplotly(gráfico_Madeira, tooltip = "text") %>%
...
Através do gráfico em baixo à esquerda, que sobrepõe a evolução do Número Reprodutivo Efetivo das várias ARS's, é possível realizar uma análise comparativa entre regiões. No gráfico do lado direito, estão identificados os Rt's atuais das diferentes ARS's.
<br>
