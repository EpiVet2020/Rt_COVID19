...
Em finais de Outubro, os valores de Rt voltaram a aumentar, possivelmente com a abertura de algumas restrições. Em Setembro, o Rt chegou a atingir valores de 1,358 com o consequente regresso às aulas, tendo atingido o valor mais alto no dia 16 de Outubro de 2020 (Rt = 1,477).
...
Através da análise deste gráfico, podemos verificar que a ARS Norte apresentou o valor mais alto de Rt no início da pandemia (6,14 no dia 7 de Março), o que justifica o elevado número de casos nesta região no período inicial. O elevado número de contágios não foi eficazmente controlado até serem implementadas medidas de restrição em todo o país (dias 16 e 18 de Março). 
Até dia 1 de Junho os valores de Rt foram diminuindo, chegando a apresentar o valor mais baixo desde o início da pandemia (0,33). Desde então, o Rt voltou a apresentar valores acima de 1, tendo apresentado um segundo pico no dia 8 de Junho (1,674).
